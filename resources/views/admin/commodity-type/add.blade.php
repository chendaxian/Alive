        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('commodityTypesStore') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="form-group">
                                <label for="wechat_name" class="control-label col-lg-2 alignRight">类别名称:</label>
                                <div class="col-lg-4">
                        ...
                        <div class="row m-t-15">
                            <div class="form-group">
                                <label for="wechat_name" class="control-label col-lg-2 alignRight">类别图片:</label>
                                <div class="col-lg-4">
                        ...
                        <div class="row m-t-15">
                            <div class="form-group">
                                <label for="wechat_name" class="control-label col-lg-2 alignRight">图片预览:</label>
